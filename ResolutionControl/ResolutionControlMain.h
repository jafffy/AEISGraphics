...
namespace ResolutionControl
{
    class ResolutionControlMain : public DX::IDeviceNotify
    {
    public:
        ResolutionControlMain(const std::shared_ptr<DX::DeviceResources>& deviceResources);
        ~ResolutionControlMain();
