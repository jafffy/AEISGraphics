...
namespace BinaryTreeVoxelizerHolo
{
    class BinaryTreeVoxelizerHoloMain : public DX::IDeviceNotify
    {
    public:
        BinaryTreeVoxelizerHoloMain(const std::shared_ptr<DX::DeviceResources>& deviceResources);
        ~BinaryTreeVoxelizerHoloMain();
