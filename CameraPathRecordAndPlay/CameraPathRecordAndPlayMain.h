...
namespace CameraPathRecordAndPlay
{
    class CameraPathRecordAndPlayMain : public DX::IDeviceNotify
    {
    public:
        CameraPathRecordAndPlayMain(const std::shared_ptr<DX::DeviceResources>& deviceResources);
        ~CameraPathRecordAndPlayMain();
